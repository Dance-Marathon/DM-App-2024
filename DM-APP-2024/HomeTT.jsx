...
const Home = ({ route }) => {
  ...
  const fetchDates = async () => {
    try {
      ...
      const currentDate = new Date(INITIAL_DATE).getTime(); // Get the current date in milliseconds

      let filteredItems = [];

      // should not show past dates if not deleted on firebase
    ...
    setAllNotifications(filteredItems.reverse()); // Assuming setAllNotifications is a state setter
  ...
  return (
    ...
    >
      ...
      <ScrollView style={{ width: "93%", maxHeight: "60%" }}>
      ...
      <Text style={styles.mapText}>Transform Today Maps</Text>
      <View style={styles.mapView}>
        <TouchableOpacity
          style={styles.mapButton}
          onPress={() => setMapModalVisible(true)}
        >
          <Text style={styles.buttonText}>CLICK TO VIEW MAPS</Text>
        </TouchableOpacity>
      </View>
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            >
              <Image
                source={require("./images/tt_campus_engagement.png")}
                style={{ width: 300, height: 180, resizeMode: "contain" }}
              />
              <Image
                source={require("./images/tt_north_lawn.png")}
                style={{ width: 300, height: 220, resizeMode: "contain" }}
              />
              <Image
                source={require("./images/tt_breezeway.png")}
                style={{ width: 305, height: 220, resizeMode: "contain" }}
              />
            </TouchableOpacity>
          </View>
        </View>
